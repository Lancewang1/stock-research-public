...
这个产品不应被定义为“会回答债券问题的聊天机器人”，而应被拆成两个相互连接的工作台：

1. **Asia Credit Copilot**：连接信用主体、研究观点、债券与贷款条款、风险事件、市场行为和组合暴露，回答“信用发生了什么变化，风险如何传导，我应关注哪项资产”。
2. **Asia Rates & FX Copilot**：连接隔夜大类资产、宏观与央行事件、利率曲线、FX carry/roll/volatility、盘中异动、资金日历和债券组合对冲，回答“Rates 与 FX 在什么时候因何变化，当前结构是否可交易，风险应如何管理”。
...
本章保留 11 个场景。原 C8“主权—银行—企业信用传导图”不再作为独立产品场景；所需的关联关系和风险传导能力并入 C3 与 C6。为保持既有讨论和引用稳定，C9—C12 暂不重新编号。连同 Rates & FX 的 8 个场景，当前共定义 19 个场景。

### C1. 信用研究整合、横截面对标与观点演化（P0/P1）

- **谁**：买方信用分析师、行业研究员、信用 PM、投资委员会成员。
- **什么时候**：首次覆盖、财报或重大事件发布后、月度/季度复核前，以及需要形成或挑战信用观点时。
- **要解决什么**：在公司披露、评级报告、卖方研究和内部历史判断之间建立统一的信用研究视图。横截面上，一方面比较不同卖方机构对同一主体的预测、评级、公允利差、催化剂和风险判断，识别共识与真正分歧；另一方面将该主体与合适的行业 peers 比较，判断其业务质量、杠杆、流动性、再融资能力、外币资产负债与收入错配、债券结构和市场估值处于什么位置。时序上，追踪同一主体及各家机构的观点如何随财报、融资、评级、汇率和其他事件变化，判断哪些假设得到验证、哪些机构领先或滞后于事实与市场。
- **现在怎么解决**：分析师分别下载多期财报、公告、评级和卖方报告，在 Excel 更新指标，在不同文档中寻找同业口径和历史观点；报告版本、数据截止日、预测口径和 peer 选择经常不一致，跨中文、英文、日文、韩文材料时还需人工翻译。
- **AI 应如何介入**：整合多语言、多版本研究材料，把“公司已披露事实、外部机构观点、内部判断和市场定价”分开；生成同一主体的跨机构观点比较、主体对 peers 的横截面对标，以及按事件组织的观点演化时间线；识别外币债务、收入、成本和现金之间的结构性错配及其变化，解释 peer 的纳入/排除理由和各家观点分歧的来源，并为事实与观点保留原文引用和 as-of time。
- **关键数据**：审计财报、临时公告、业绩会材料、评级报告、卖方研究及其历史版本、分币种债务到期表、收入/成本/现金币种构成及对冲披露、债券价格/利差、FX、行业与同业指标、内部信用备忘录和历史投资判断。
...
本章保留 8 个场景，将原独立 FX 场景并入 Rates 的同类工作流。原 R6“组合久期、关键期限风险与宏观情景对冲”和 R7“跨市场、汇率对冲后收益比较”暂不纳入本轮场景；R8 改为资金与事件日历，R9 为盘中盯盘，并新增 R10 债券组合 FX hedge、roll 与执行。为保持既有讨论和引用稳定，暂不重新编号。

### R1. 亚洲开盘晨报：隔夜 Rates、FX 与大类资产时间线（P0/P1）

- **谁**：利率 PM、宏观策略师、交易员、机构销售。
- **什么时候**：亚洲各市场开盘前，以及伦敦/纽约向亚洲交接时。
- **要解决什么**：客户需要的不是一组 close-to-close 涨跌幅，而是一条可核查的隔夜市场时间线：在亚洲收盘、伦敦交易和纽约交易的不同时段，哪一个资产先动、何时加速或反转、幅度多大，当时发生了什么，以及这个变化如何传导到其他资产。重点覆盖 UST 曲线与期货、主要股指、美元及亚洲 spot/forward/NDF、原油和黄金、信用利差、政策利率预期，并映射到 JGB、CGB、KTB、IGB、MGS 等本地曲线及相关 FX。
...
### R2. 央行反应函数与 Rates/FX 议息会议 Copilot（P0/P1）

- **谁**：宏观策略师、利率/FX 交易员、经济学家、资产配置团队。
- **什么时候**：议息会前一至两周、决定发布瞬间、记者会和会议纪要发布后。
- **要解决什么**：理解每家亚洲央行当前最重视的增长、通胀、汇率、金融稳定变量；区分基准情景与尾部情景；判断声明措辞和政策工具发生了什么变化，并比较不同结果对 Rates、spot、forward points、NDF 和 FX volatility 的条件化影响。
- **现在怎么解决**：人工读声明、演讲和纪要，维护政策表格并参考卖方预测；语言差异和政策框架差异使跨国比较非常耗时。
- **AI 应如何介入**：逐句比较历次声明；建立可更新的 reaction-function card；结合 point-in-time 宏观数据和 Rates/FX 市场定价生成条件概率树；会前比较不同机构对政策路径和市场反应的分歧，会后立即区分“决定、措辞、预测、操作工具”四类 surprise，并对照曲线、spot、forward 和 vol 的真实变化。
- **关键数据**：央行声明/纪要/演讲、官方预测、宏观 vintage、调查预期、OIS/IRS、spot/forward/NDF、FX vol surface 和历史会议反应。
...
### R4. Rates 曲线与 FX carry/roll/volatility 相对价值回测机（P1/P2）

- **谁**：本币债 PM、利率和 FX RV 交易员、宏观 PM、options trader、银行自营盘和系统化研究团队。
- **什么时候**：每日筛选，曲线、swap spread、forward points、cross-currency basis 或 FX volatility 异常，政策预期变化，以及准备建立或复核相对价值交易时。
- **要解决什么**：在同一研究框架中分析两类机会。Rates 侧识别 2s5s10s、5s10s30s、现券—IRS、国债—准主权和跨品种结构的偏离；FX 侧比较不同亚洲货币的 spot、forward/NDF carry、roll-down、利差、cross-currency basis、估值和动量，并分析 ATM vol、risk reversal、butterfly、期限结构与 realized volatility 的关系。历史百分位只是起点，用户还需要将观点写成明确规则，回测入场、退出、持有期、止损、carry/roll、volatility regime、融资、hedging 和交易成本，判断结构在不同参数、市场状态和样本外时期是否仍然成立。
- **现在怎么解决**：Rates 和 FX 团队分别维护 Excel、Python、BQuant、vol surface 和卖方 scorecard；历史 z-score/百分位与交易回测经常分开，Rates 的 day count、CTD、repo、roll 规则与 FX 的 deliverable/NDF、forward tenor、holiday、delta/vol convention 和资本管制处理不一致；研究容易停留在挑选案例或最优参数。
- **AI 应如何介入**：允许用户用自然语言提出 Rates/FX RV 假设和筛选条件，但由统一定价与回测引擎转换为无歧义规则；并列输出当前水平、历史百分位、carry/roll、forward/basis、implied-versus-realized vol、风险中性盈亏平衡和完整回测结果；强制检查 point-in-time 数据、look-ahead、bid/ask/slippage、参数敏感性、不同 regime、walk-forward/样本外表现和失败区间，优先寻找稳定参数区间，而不是最高样本内收益。
- **关键数据**：Rates 侧包括可交易现券、OIS/IRS、期货及 CTD、repo、发行计划和曲线历史；FX 侧包括 spot、forward/NDF、local/USD curves、cross-currency basis、可成交 vol surface、realized vol、positioning、资本流动和可交易性标签；两侧均需要 bid/ask、交易与融资成本、point-in-time 历史、合约条款及市场 convention。
- **成功指标**：定价和 P&L 与交易台/BQuant/独立期权基准的一致性、look-ahead 和 convention 错误数、成本后及样本外表现、参数与 regime 稳定性、vol surface 解释正确率、候选交易人工接受率，以及回测到事后实盘表现的偏差。

**重要边界**：回测的目标是判断策略在现实摩擦下是否“最不容易失效”，不是寻找历史收益最高的参数；样本不足、只在单一 regime 有效或对成本高度敏感的策略应明确标为不可验证或不稳健。高 FX carry 不是无风险收益，缺失的 options 报价也不能被插值成可交易流动性。
...
### R8. Rates & FX 资金、政策与事件日历（P0/P1）

- **谁**：利率 PM、交易员、宏观策略师、银行资金交易员、treasury 和风险值班团队。
- **什么时候**：每天开盘前和盘中更新；重点覆盖未来一日、一周和一个月，以及月末/季末、税期、长假、国债集中交割和央行流动性操作窗口。
- **要解决什么**：把每天可能影响 Rates、FX 与资金面的事件放在同一时间轴上，包括关键宏观数据、央行会议与讲话、公开市场操作及到期、政府债发行/拍卖/结算/到期付息、财政收支和税款、repo 与资金利率窗口、fixing、外储和干预相关发布、资本管制或结算规则、forward/NDF 与 hedge roll、指数再平衡、重要假日和已知监管事件；同时记录可观察的资金行为和预期流动性影响，帮助用户判断“今天什么时候可能有波动、资金是投放还是回笼、哪些 Rates/FX 期限最可能受影响”。
...
- **AI 应如何介入**：建立 point-in-time 的 Rates & FX event ledger，统一事件的当地时间、公布时间、实施时间和结算时间；自动识别新增、取消、修改和超预期规模，按市场、事件类型、期限和预期流动性方向组织每日清单；把已知资金投放/回笼、国债现金流、FX fixing、hedge roll 和结算需求与历史季节性对照，并在事件发生后补充实际结果和市场反应。
- **关键数据**：官方经济日历、央行会议/讲话和公开市场操作、政府债发行与拍卖、财政收支和税期、国债到期/付息/结算、repo/拆借/OIS、fixing、外储、资本管制和结算通知、forward/NDF/option expiry、指数调整、交易所与本地假日、内部获准使用的资金与 hedge roll 计划及历史事件反应。
...
### R9. Rates & FX 盘中盯盘、异动归因与政策风险（P1/P2）

- **谁**：利率交易员、PM、销售交易、银行自营盘、市场风险和值班团队。
- **什么时候**：亚洲、伦敦和纽约交易时段持续运行；在数据发布、央行操作、拍卖、新闻或价格/成交异常时重点触发。
- **要解决什么**：连续观察现金国债、国债期货、OIS/IRS、swap spread、repo、breakeven，以及 spot、forward/NDF、onshore/offshore basis、FX vol/skew 的水平、曲线形态、价差、成交量与流动性变化；同时监测 fixing 异常、口头/实际干预、资本管制和可兑换性风险。发现单一市场或跨市场异动后，回答“什么资产在什么时候先动、变化是否扩散、是否有真实成交或报价支持、与哪项已知事件同时发生、哪些解释仍缺证据”。
...
- **AI 应如何介入**：把获准使用的实时行情、成交、broker/dealer 报价和事件流统一到同一市场时钟，监测 Rates outright/curve/butterfly/swap spread/cash-futures basis、FX spot/forward/basis/vol surface 和 funding 指标的状态变化；结合央行/监管公告、fixing 和在岸离岸价格区分已确认政策行动、市场推测和季节性流量；对异常生成带原始价格路径、成交/报价佐证、关联事件、置信度和反证的分级告警，并保存盘中观点如何随新证据更新。
- **关键数据**：现金国债和期货 tick/order book、OIS/IRS 和 swap spread、repo/拆借、breakeven、spot/forward/NDF、onshore/offshore basis、FX vol surface、broker/dealer quotes、成交量和持仓量、央行/监管公告和 fixing、内部获准的 RFQ、成交和仓位数据。
...
### R10. 债券组合 FX hedge、roll 与执行管理（P1/P2）

- **谁**：全球债券 PM、保险/养老金 ALM、基金 treasury、FX execution trader、风险、交易主管和合规。
- **什么时候**：买入外币债、对冲到期滚动、基金申赎、FX 或 basis/forward points 大幅变化、大额 spot/forward/NDF/roll 下单前，以及交易后 best-execution 复盘时。
- **要解决什么**：根据基准币种、逐笔债券现金流、净资产和风险预算决定 hedge ratio，比较 deliverable forward、NDF、FX swap 和 option 的 carry、basis、tail risk、流动性、会计与监管约束；同时选择执行时段、venue、dealer 和拆单方式，并解释交易后滑点来自 spread、市场冲击、延迟、last look 还是 benchmark 选择。
- **现在怎么解决**：组合通常按月使用固定 hedge ratio 批量滚动，现金流和到期日在 Excel 汇总；PM 观点、treasury 计划、dealer 报价和执行复盘分散在不同系统，动态对冲决策与实际交易成本难以连成可审计链。
- **AI 应如何介入**：读取逐笔债券现金流与基准币种，生成静态、动态和尾部保护方案，由确定性引擎计算 hedge cost、roll schedule、basis 和情景 P&L；结合历史 RFQ/fill 建立条件化流动性图，给出需人工批准的执行方案，并在成交后生成可审计 TCA，解释计划、执行和最终对冲效果之间的偏差。
- **关键数据**：持仓和现金流、spot/forward/NDF/swap、cross-currency basis、可成交 vol surface、基金申赎、会计/监管规则、内部限额、逐笔 quote/RFQ/order/fill、venue/dealer、market tick、拒单/last-look 和历史执行成本。
- **成功指标**：未解释 FX P&L、对冲成本、现金流错配、roll 失败和超限次数，implementation shortfall、fill ratio、TCA 解释覆盖率，以及对冲计划与实际风险下降的一致性。

**重要边界**：AI 只生成分析与待审批方案，不直接执行 hedge；单一 dealer 或 venue 的历史不能代表全市场流动性，客户持仓、交易意图和 dealer 数据必须严格权限隔离。

---

## 3. FX 场景整合边界

FX 不再作为独立产品工作台或单独编号的场景清单，而是按用户的实际决策流程并入 Rates & FX 和 Credit：

- 亚洲开盘、央行会议和宏观数据事件中的 FX 分析归入 R1—R3，与 Rates 和其他大类资产使用同一时间线和证据标准。
- FX carry、roll-down、估值、动量、basis、implied/realized volatility、skew 和尾部保护归入 R4 的统一历史百分位与策略回测机。
- 干预、资本管制、可兑换性、fixing 和在岸/离岸异常归入 R8 的事件日历与 R9 的盘中监控。
- 债券组合的动态 FX 对冲、hedge roll、执行和 TCA 归入 R10。
- 企业外币错配不作为独立 FX 场景，其研究、告警和组合压力能力分别归入 C1、C3 和 C6。
...
|---|---|---:|---:|---|---|
| Bloomberg Terminal / Data License / B-PIPE / BVAL | 实时与历史行情、债券主数据、曲线、evaluated price、新券、新闻、财务与分析工具 | 高 | 高 | C | 亚洲机构覆盖广；终端席位不自动包含服务器 API、训练、缓存或再分发权 |
| LSEG Workspace / Real-Time / Tick History | 跨资产实时与历史、Refinitiv instrument master、新闻、交易与宏观 | 高 | 高 | C | 适合 Bloomberg 冗余或替代；需分别确认 tick、server、derived data 和 AI 权利 |
| ICE Data Services | 债券主数据、evaluated pricing、固定收益指数与部分实时/历史数据 | 高 | 中 | C | 适合估值和组合；evaluated price 不是可成交报价，派生/展示权需谈判 |
| S&P Global Market Intelligence / Capital IQ / iBoxx / Markit 模块 | 公司财务、债券/指数、CDS、经济与行业数据，具体取决于模块 | 高 | 高 | C | 产品线分散；不能假设一个合同覆盖全部内容 |
| Moody's CreditView / S&P RatingsDirect / Fitch Connect | 评级、评级行动、方法论、信用研究 | 高 | 低 | B/C | 评级行动标题常公开，完整报告和批量历史通常付费；训练及大段输出权高度敏感 |
| Sell-side research portals / licensed research feeds | 卖方信用研究、宏观数据 preview/review、预测、评级/推荐、公允利差与历史观点版本 | 高 | 高 | C/D | C1/R3 的跨机构观点比较需要合法取得历史版本；终端阅读权不等于批量摄取、跨用户展示或模型训练权 |
| Wind / iFinD | 中国宏观、在岸债券、发行人财务、公告及部分全球市场数据 | 高 | 高 | C | 中国市场很有价值；亚洲跨国覆盖和实时 OTC 深度需验证；API 与 AI 使用权另谈 |
| CEIC / Macrobond / Haver | 亚洲及全球宏观历史、季调、共识/高频指标，依供应商而异 | 中 | 高 | C | 显著减少各国数据工程；vintage、导出、服务器及再分发权限需确认 |
| Dealogic DCM / LSEG Deals / Bloomberg new issue tools / IFR | 债券发行、承销、league table、定价过程、pipeline 和市场报道 | 高 | 中 | C | 对 C2/C12 很关键；已宣布发行可商业获取，实时 book color、未公开 pipeline 和完整订单仍属于承销团/内部数据 |
| MarketAxess | 机构信用债 RFQ、交易、流动性/估值类数据及执行工作流 | 高 | 低 | C/D | 需机构客户和合同；覆盖取决于债券与地区，不能视为全市场 order book |
| Tradeweb | 国债、利率衍生品、信用和部分 FX 的电子交易/市场数据 | 中 | 高 | C/D | 最有价值的数据往往与交易接入绑定；历史和派生用途另行许可 |
| Sell-side dealer/broker 报价渠道 | Dealer axes、indicative/firm quotes、runs、broker markets；可能经 Bloomberg IB/ALLQ、LSEG Messenger、合规邮箱、CSV/FIX/API 或交易平台送达 | 高 | 高 | D/E | 数据通常属于客户可见的双边/定向信息而非公共行情；能阅读不等于允许机器抓取，必须取得渠道、dealer 与客户合规授权 |
| BondbloX / BondEvalue 等亚洲债券平台 | 亚洲债券价格发现、分级交易或估值/分析，依产品而异 | 高 | 低 | C/D | 有亚洲特色，但覆盖、可成交深度、API 和历史需逐券 POC 验证 |
| Cbonds | 全球债券主数据、到期/票息/call 等公司行动、价格/指数和发行信息 | 高 | 中 | C | 可补 C10/C12 的 instrument master 和现金事件；机构级实时准确性和地域覆盖需抽样测试 |
| FINRA TRACE | FINRA 成员上报的 TRACE-eligible 债券成交 | 高 | 低 | A/B/C | 对部分亚洲美元债有价值，但不覆盖全部 Reg S/离岸 OTC 活动；免费、延迟、历史和订阅产品粒度不同 |
| DTCC Swap Data Repository 公共披露 | 美国报告制度下部分利率/信用/FX 衍生品交易 | 中 | 中 | A/B | 原始数据量大、修订多、匿名且字段复杂；只能视作市场活动的部分窗口 |
| CME / SGX / HKEX / JPX / KRX 等交易所数据 | 上市利率、FX 期货/期权、成交与持仓 | 低 | 高 | A/B/C | EOD 常较易得，实时 tick/order book 通常收费；对 OTC 市场只是代理 |
| EBS / 360T / Currenex / FXall 等 FX 场所 | spot、forward、swap/NDF 报价、成交和执行 | 低 | 高 | C/D | 通常需交易关系；单一场所不代表全市场，客户数据隔离要求高 |
| CLS | FX 结算量、部分聚合市场数据和机构级数据产品 | 低 | 中 | A/C | 公开多为聚合统计；详细流量非开放且覆盖受 CLS eligible currencies/participants 限制 |
| EPFR / Lipper / IIF 等资金流数据 | mutual fund/ETF flow、跨境资本流和持仓代理，具体取决于产品 | 高 | 高 | C | C12/R8 的重要底座；频率、基金覆盖、look-through、公布时滞、样本偏差和再分发权需逐项审查 |
| ETF sponsor/交易所公开文件 | shares outstanding、NAV/AUM、部分 daily holdings 与 creation/redemption 文件 | 中 | 中 | A/B/C | 大型 ETF 可低成本覆盖，但不同 sponsor 历史深度与许可不同；不能替代 mutual fund 实时申赎 |
| FactSet / Morningstar / eVestment 等 | 组合、基金、持仓、公司与市场数据，依模块而异 | 高 | 中 | C | 适合 C11/C12 的持仓、同业和资金流补充，不是亚洲 OTC 实时定价或客户 flow 的替代品 |
| PitchBook / Preqin / 9fin / KBRA DLD 等私募市场数据 | Private credit、leveraged finance、借款人、sponsor、交易条款和可比案例，依产品而异 | 高 | 低 | C | 可为 C7 提供市场背景和可比交易，但无法替代客户 data room、贷款文件、工程尽调和持续 borrower reporting |
| Reuters / Bloomberg News / Dow Jones Newswires | 可信实时新闻和机器可读新闻产品 | 高 | 高 | C | 终端阅读权与机器摄取权不同；摘要、保存、训练和对客展示需单独许可 |
| GDELT / 经许可的开放新闻源 | 全球多语言新闻和事件元数据 | 中 | 中 | A/B | 适合低成本事件发现，不适合单独作为信用事实来源；需去重、来源评级和版权控制 |
...
| BIS Data Portal | 政策利率、有效汇率、信贷、跨境银行、债务证券、衍生品统计 | A | C3、C6、R2、R4、R8/R9 | 频率偏低、修订和口径需要 point-in-time 管理 |
| IMF Data / IFS / WEO / COFER | 宏观、国际收支、外储、预测与全球比较 | A/B | C3、C6、R2、R4、R8/R9 | 部分详细数据/API 或下载方式会变化；COFER 多为聚合 |
| World Bank Data / International Debt Statistics | 宏观、外债、发展与主权指标 | A | C1、C3、C6 | 频率低，不适合实时交易 |
| OECD Data | 成员经济体宏观与领先指标 | A/B | R2、R4 | 亚洲新兴市场覆盖不完整 |
...
| UN / OFAC / EU / UK HMT 等制裁清单 | 制裁主体、船舶、项目与规则 | A/B | C3、R8/R9 | 名称匹配误报高；需本地监管和商业 KYC 数据补充 |
...
| Treasury、融资、公开市场操作计划、抵押品和保证金 | R8/R9/R10、组合流动性与 FX hedge roll | D | 高敏感、实时性、职责分离与操作审批；内部资金计划不得与公开日历混为已披露事实 |
...
| Rates & FX | 央行/统计局、官方曲线与拍卖、EOD 国债/大类资产/spot/forward/NDF、公开 fixing/外储/国际收支、经济与资金事件日历 | 分钟/tick 级国债、OIS/IRS、期货和跨资产行情，逐家调查与获准研究，repo、可成交 spot/forward/NDF、cross-currency basis、vol surface、broker/dealer/venue quote、RFQ/fill、持仓现金流、内部资金与 hedge roll 数据 | 没有高频行情不能承诺精确隔夜时间线和盘中盯盘；没有 point-in-time 数据、完整 convention 和可成交成本不能承诺可靠的 Rates/FX RV 回测；没有持仓现金流和执行数据不能承诺真实 hedge cost、动态对冲、best execution 或 dealer/venue 排序 |
...
### 8.2 Rates & FX 重点场景的数据可得性

| 场景 | POC 最小数据 | 机构版必须补齐 | 可获取性判断 |
|---|---|---|---|
| R1 Overnight Rates & FX Timeline Brief | 分钟级 UST futures、主要 FX/equity/commodity、官方经济日历和可信新闻 | 完整 UST/OIS/IRS、spot/forward/NDF、信用指数、机器可读新闻、跨市场 tick 和统一时钟 | A/B/C 可做主要资产时间线；高覆盖、低延迟和可靠事件归因需要 C，部分亚洲 OTC 市场仍只能用代理 |
...
| R4 Rates Curve & FX Carry/Roll/Volatility Backtester | EOD point-in-time 曲线、spot/forward/NDF、基础 vol/realized vol、合约规则和交易成本假设 | 可执行现券/OIS/IRS/期货、CTD、repo、bid/ask，以及 FX basis、完整 vol surface、delta/holiday/NDF convention、融资和 hedging 成本、BQuant/交易台/期权基准 | B/C 可展示历史百分位与研究回测；可交易、成本可信且无 look-ahead 的生产回测需要 C/D，并必须经过参数、regime 和 walk-forward/样本外验证 |
| R8 Rates & FX Funding/Event Calendar | 官方数据日历、央行操作、政府债发行/到期/结算、税期、fixing、option expiry、forward/NDF roll 和假日 | repo/拆借、财政与准备金细节、内部获准资金与 hedge roll 计划和历史实际资金行为 | A/B 可建立公开日历；完整净流动性和 FX roll 判断依赖 C/D，且内部计划必须权限隔离 |
| R9 Rates & FX Market Monitor | 交易所期货、主要 spot/forward/NDF 和部分现券/曲线实时数据、公开事件流 | OTC OIS/IRS、repo、FX basis/vol surface、broker/dealer/venue quote、RFQ/fill、内部仓位和多场所 tick | 交易所和主要 FX 市场可用 A/B/C 建立骨架；亚洲 OTC 全市场盯盘需要 C/D，单一数据源不能代表整体市场 |
| R10 FX Hedge, Roll & Execution | 模拟组合现金流、EOD spot/forward/NDF/basis 和基础成本假设 | 实际持仓与申赎、可成交 forward/NDF/swap/option、内部限额、逐笔 quote/RFQ/order/fill、venue/dealer 和 TCA benchmark | POC 可比较静态 hedge cost；动态对冲、真实 roll 成本、best execution 和 TCA 均依赖 D，且必须保留人工审批 |
...
- R1/R3/R8/R9 必须统一保存当地市场时间和 UTC，并区分 scheduled time、actual release time、headline arrival、research publish time 与 price reaction window；R4 回测只能读取当时已经可得的 Rates 曲线、spot/forward/NDF、vol surface、合约 convention 和成本数据。
...
1. **C1 信用研究整合、横截面对标与观点演化**：最能体现多语言长文档、跨机构比较和历史观点追踪能力，并把分币种债务、收入、成本、现金与对冲披露纳入主体和 peer 分析。
...
5. **R8 Rates & FX 资金、政策与事件日历**：先用官方数据建立每日 key release、央行操作、发行结算、fixing 与 hedge roll 事件底座。
...
7. **R4 Rates 曲线与 FX carry/roll/volatility 回测机**：用 BQuant demo 展示统一历史百分位与策略回测，并补齐 point-in-time、完整交易/融资/hedging 成本、参数稳健性、regime 和 walk-forward/样本外验证。
8. C6 组合多因子风险、动态相关性与压力测试。
9. **R10 债券组合 FX hedge 与 roll 一期**：接入持仓现金流和可成交 forward/NDF/basis，在人工审批下比较静态、动态和尾部保护方案。
...
5. **R9 Rates & FX 盘中盯盘**：接入实时 OTC Rates、spot/forward/NDF、FX vol、repo、报价、成交和 RFQ，形成跨产品异动与证据化归因。
6. **R4 FX volatility 扩展**：接入可成交 vol surface，比较 ATM、risk reversal、butterfly、期限结构和 implied-versus-realized volatility，并回测尾部保护结构。
7. **R10 FX 执行与 TCA 二期**：接入 venue/dealer quote、order/fill 与 benchmark，形成执行前流动性选择和交易后 TCA。
...
| 时效性 | 来源发布到结构化、告警或首稿的延迟 | C2/C3/C9/R1/R2/R3/R8/R9 |
| 计算正确性 | 与前台/风险/独立 benchmark 的差异，VaR/Expected Shortfall 回溯表现 | C5/C6/R4/R9/R10 |
| 决策价值 | 人工接受率、节省时间、后续修改量、异常发现数 | 全部 |
| 交易质量 | 滑点、fill ratio、成本后收益、对冲误差 | C2/C5/R4/R10 |
...
| Rates & FX 时间线与事件 | 拐点覆盖率、时间对齐误差、细分项 surprise 准确率、无证据归因率、日历遗漏率 | R1/R3/R8/R9 |
| Rates & FX RV 回测 | point-in-time 正确率、carry/roll/vol 计算与 convention 准确率、成本后和样本外表现、参数/regime 稳定性、实盘偏差 | R4 |
| FX hedge 与执行 | 对冲成本、未解释 FX P&L、现金流错配、roll 失败率、implementation shortfall、TCA 覆盖率 | R10 |
